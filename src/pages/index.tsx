  ...
  return (
    <div className="relative h-full w-full overflow-clip">
      <Image
        ...
        className="absolute z-0 h-full w-full min-w-[1000px] opacity-10"
        width={1000}
        height={1000}
        alt="-"
      />
      ...
      >
        ...
        >
          <div className="flex items-center gap-2">
            ...
            >
              <Github className="h-6 w-6 border border-blue p-1 hover:bg-white/10 md:h-8 md:w-8" />
            </a>
          </div>
          <div className="flex items-center gap-2 text-xs font-semibold sm:text-sm md:gap-3 md:text-base">
            <button className="border border-blue p-1 hover:bg-white/10">
              Contact
            </button>
            <button className="border border-blue p-1 px-2 hover:bg-white/10">
              CV
            </button>
          </div>
        </div>
